                  ...
                  <div class="col-lg-12 main-chart">
						...
						<table class="table table-striped">
							<form action="fungsi/edit/edit.php?barang=edit" method="POST">
								...
								<tr>
									<td>Harga Beli</td>
									<td><input type="number"  min="0" class="form-control" value="<?php echo $hasil['harga_beli'];?>" name="beli"></td>
								</tr>
								<tr>
									<td>Harga Jual</td>
									<td><input type="number" min="0" class="form-control" value="<?php echo $hasil['harga_jual'];?>" name="jual"></td>
								</tr>
								<tr>
									<td>Satuan Barang</td>
									<td>
								...
								<tr>
									<td>Stok</td>
									<td><input type="number" min="0" class="form-control" value="<?php echo $hasil['stok'];?>" name="stok"></td>
								</tr>
								<tr>

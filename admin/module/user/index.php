                  ...
                  <div class="col-lg-12 main-chart">
						...
						<?php }?>
									...
									<div class="panel-footer">
										<form method="POST" action="fungsi/edit/edit.php?gambar=user" enctype="multipart/form-data">
											...
											<span class="pull-right">
												<button type="submit"  class="btn btn-primary btn-sm" value="Tambah"><i class="fa fa-pencil"> Ganti Foto Profil</i></button>
											</span>
										</form>
										<br/>
										<br/>
							...
							<div class="col-sm-5">
								<div class="panel panel-primary">
									<div class="panel-heading">
										<h4><i class="fa fa-user"></i>  Data Pengguna </h4>
									</div>
									<div class="panel-body">
